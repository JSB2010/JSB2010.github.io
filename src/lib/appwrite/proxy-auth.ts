// Appwrite authentication service using proxy client
import { ID, Models } from 'appwrite';
import { proxyServices } from './proxy-client';
...
/**
 * Authentication service for Appwrite using proxy
 */
export class ProxyAuthService {
  private account = proxyServices.account;
